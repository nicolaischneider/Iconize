...
def parse_args():
    parser = argparse.ArgumentParser(
        description="An Image Resizer by Nicolai Schneider."
    )
    ...
    parser.add_argument(
        ...
        nargs="+",
        type=int,
        help="Specific sizes to resize to. E.g. --specific 20 30, this will resize the image to 20x20 and 30x30 pixels.",
    )
